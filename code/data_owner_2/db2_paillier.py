...
def open_excel(file='test_data/test_db2.xls'):
    try:
...
def write_excel(file='test_data/test_db2.xls'):
    ...
    xls = xlwt.Workbook()
    sheet1 = xls.add_sheet(u'test_db2_encrypted', cell_overwrite_ok=True)
    for i in range(nrows):
        citems = []
        for j in range(ncols):
        ...
        print (citems)
    xls.save('test_data/test_db2_encrypted.xls')
...
def main():
    ...
    filename = 'test_data/test_db2_encrypted.xls'
    sender = 'data_owner_2'
